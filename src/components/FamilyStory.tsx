    ...
    >
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <p className="font-inter text-lg md:text-xl text-charcoal/70 max-w-2xl mx-auto">
            {t.subtitle}
          </p>
        </div>
        ...
        <div className="relative">
          ...
          <div className="hidden md:block absolute left-1/2 transform -translate-x-1/2 w-1 h-full bg-golden-yellow/30" />

          {/* 1990s */}
          <div className="mb-16 grid md:grid-cols-2 gap-8 items-center">
            <div className="md:text-right">
              <div className="bg-white p-6 md:p-8 rounded-2xl shadow-lg w-full md:inline-block">
                <span className="font-playfair text-3xl md:text-4xl text-flame-red font-bold">
                  {t.timeline[1990].year}
                </span>
                <h3 className="font-playfair text-xl md:text-2xl text-charcoal mt-2 mb-4">
            ...
            <div className="relative rounded-2xl overflow-hidden shadow-xl order-first md:order-last">
              <LazyImage
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div className="relative rounded-2xl overflow-hidden shadow-xl order-first">
              <LazyImage
        ...
        <div className="text-center mt-16">
          <a
            href="#story"
            className="inline-flex items-center gap-2 bg-charcoal hover:bg-flame-red text-white px-8 md:px-10 py-3 md:py-4 rounded-full font-inter font-bold text-base md:text-lg transition-all duration-300 shadow-lg"
          >
            {t.cta}
            <span>→</span>
          </a>
